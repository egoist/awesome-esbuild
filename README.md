...
- [Discussions about the plugin API](https://github.com/evanw/esbuild/issues/111): You will be able to build plugin in JS, you can also use esbuild as a Go library to build your own bundler for best performance. 
